...
public class TicketsController {
    ...
    public ResponseEntity<BaseResponse<List<GetTicketDto>>> getTicketsByUserEmail(@PathVariable String email, WebRequest webRequest){
        ...
        BaseResponse<List<GetTicketDto>> responseBody = baseResponseHelpers.createBaseResponse(HttpStatus.OK, MessageType.FOUND, MessageFormat.format("Certificates were successfully retrieved for user with the email: {0}",email), webRequest, responseData);
